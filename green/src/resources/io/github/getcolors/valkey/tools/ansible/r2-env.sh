...
export RCLONE_CONFIG_BACKUP_ENDPOINT="<{ valkey-backup-r2-endpoint }>" RCLONE_CONFIG_BACKUP_REGION="<{ valkey-backup-r2-region }>"
...
PROFILE="<{ profile }>"
BACKUP_BUCKET="<{ valkey-backup-r2-bucket }>"
SET_PREFIX="<{ valkey-backup-set-prefix }>"
RETENTION_DAYS=<{ valkey-backup-retention-days }>
MAX_AGE_HOURS=<{ valkey-backup-max-age-hours }>
VALKEY_IMAGE="<{ valkey-image }>"
